module.exports = class Data1703265981100 {
    name = 'Data1703265981100'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "core" ("id" character varying NOT NULL, "latest_claim_block" integer NOT NULL, "core_id" integer NOT NULL, "total_rewards" text NOT NULL, "total_unclaimed" text NOT NULL, CONSTRAINT "PK_3b1e52368e24baad3e1ad2b7d8b" PRIMARY KEY ("id"))`)
    }
