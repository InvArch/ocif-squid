...
export interface RegisteredCoreV15  {
    ...
    getMany(block: Block, keys: number[]): Promise<(v15.CoreInfo | undefined)[]>
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v15.CoreInfo | undefined)][]>
...
export const coreEraStake =  {
    v15: new StorageType('OcifStaking.CoreEraStake', 'Optional', [sts.number(), sts.number()], v15.CoreStakeInfo) as CoreEraStakeV15,
}

export interface CoreEraStakeV15  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key1: number, key2: number): Promise<(v15.CoreStakeInfo | undefined)>
    getMany(block: Block, keys: [number, number][]): Promise<(v15.CoreStakeInfo | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: [number, number], v: (v15.CoreStakeInfo | undefined)][]>
    getPairs(block: Block, key1: number): Promise<[k: [number, number], v: (v15.CoreStakeInfo | undefined)][]>
    getPairs(block: Block, key1: number, key2: number): Promise<[k: [number, number], v: (v15.CoreStakeInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [number, number], v: (v15.CoreStakeInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, number], v: (v15.CoreStakeInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: number): AsyncIterable<[k: [number, number], v: (v15.CoreStakeInfo | undefined)][]>
}
